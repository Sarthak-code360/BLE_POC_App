export const Images = {
  onboarding: {
    ...
    foreground: require('@/assets/images/foreground.png'),
    card_auth: require('@/assets/images/card-authentication.png'),
    install_app: require('@/assets/images/install_app.png'),
  },
  icon: {
    ...
    ble: require('@/assets/images/icons/ble.png'),
